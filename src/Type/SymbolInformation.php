...
final class SymbolInformation extends BaseSymbolInformation
{
     ...
     *        range is used by a tool to reveal the location in the editor. If
     *        the symbol is selected in the tool the range's start information
     *        is used to position the cursor. So the range usually spans more
     *        than the actual symbol's name and does normally include things
     ...
     * @param bool|null $deprecated Indicates if this symbol is deprecated.
