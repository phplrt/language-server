...
{
    /**
     * @param string|null $version The version number of this document. If a
     *        versioned text document identifier is sent from the server to the
     *        client and the file is not open in the editor (the server has not
     *        received an open notification before) the server can send
     *        {@see null} to indicate that the version is unknown and the
