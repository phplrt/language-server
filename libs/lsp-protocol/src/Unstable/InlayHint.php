...
class InlayHint
{
     ...
     * @param ?InlayHintKind $kind The kind of this hint. Can be omitted in which case
     *        the client should fall back to a reasonable default.
     * @param ?list<TextEdit> $textEdits Optional text edits that are performed when
     *        accepting this inlay hint.
     *
     ...
     *        background color of the hint itself. That means padding can be used to
     *        visually align/separate an inlay hint.
     * @param mixed $data A data entry field that is preserved on an inlay hint between
