 ...
 * servers can agree on a different string encoding representation (e.g. UTF-8).
 ...
 * servers can safely assume that the client supports UTF-16. If the server omits
 * the position encoding in its initialize result the encoding defaults to the
 * string value `utf-16`. Implementation considerations: since the conversion from
 * one encoding into another requires the content of the file / line the conversion
...
{
    /**
     * @param int<0, 2147483647> $line Line position in a document (zero-based).
     ...
     * @param int<0, 2147483647> $character Character offset on a line in a
     *        document (zero-based).
