...
final class CodeLens
{
     ...
     * @param ?Command $command The command this code lens represents.
     * @param mixed $data A data entry field that is preserved on a code lens
     *        item between a `CodeLensRequest` and a `CodeLensResolveRequest`.
     */
