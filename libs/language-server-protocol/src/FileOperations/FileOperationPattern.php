...
{
    /**
     * @param string $glob The glob pattern to match. Glob patterns can have
     ...
     *        `example.0`)
     * @param ?FileOperationPatternKind $matches Whether to match files or folders with
     *        this pattern.
     *         Matches both if undefined.
     * @param ?FileOperationPatternOptions $options Additional options used during
     *        matching.
     */
