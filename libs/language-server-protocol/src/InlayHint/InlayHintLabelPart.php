...
final class InlayHintLabelPart
{
     ...
     *        `inlayHint.resolveSupport` clients might resolve this property
     *        late using the resolve request.
     * @param ?Location $location An optional source code location that
     *        represents this label part.
     ...
     *        resolves to the definition of the symbol at the given location
     *        (not necessarily the location itself), it shows the hover that
     *        shows at the given location, and it shows a context menu with
     *        further code navigation commands.
