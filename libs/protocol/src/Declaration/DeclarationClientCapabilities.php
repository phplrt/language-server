...
{
    /**
     * @param bool|null $dynamicRegistration Whether declaration supports
     *        dynamic registration. If this is set to {@see true} the client
     *        supports the new `DeclarationRegistrationOptions` return value
     *        for the corresponding server capability as well.
     * @param bool|null $linkSupport The client supports additional metadata
     *        in the form of declaration links.
     */
